class UsersController < ApplicationController
  ...
  private
    ...
    def correct_user
      @user = User.find(params[:id])
      #redirect_to(root_url) unless current_user?(@user) #TODO uncomment when home is ready
    end

    def admin_user
      # redirect_to(root_url) unless current_usre.admin? #TODO uncomment when home is ready
    end
end
